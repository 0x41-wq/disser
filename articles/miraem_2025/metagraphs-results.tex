...
\textbf{Метаграфы (Разработанная модель)} & \textbf{89.6} & \textbf{92.7} & \textbf{91.1} \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[ht]
\centering
\resizebox{\textwidth}{!}{\input{figures/attack-chain.tikz}}
...
\begin{figure}[ht]
\centering
\resizebox{0.85\textwidth}{!}{\input{figures/mitre-mapping.tikz}}
