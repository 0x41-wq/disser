...
\chapter{Экспериментальное исследование и практическая реализация}

\section{Описание экспериментальной среды}
...
\end{itemize}
\section{Реализация прототипа системы}
...
\section{Интеграция атрибутивных метаграфов с методами искусственного интеллекта}
...
\section{Ограничения и пути улучшения}
